      ...
      <div className="pt-32 pb-16 max-w-6xl mx-auto px-4">
        ...
        <div className="bg-[#000814] border border-[#FFC300] rounded-lg p-8 mb-8">
          ...
          <div className="text-gray-300 space-y-4">
            <p>
              Mission freelance pour l&apos;association &quot;Agir pour les
              séniors sourds dépendants de France&quot; consistant à créer un
              site web vitrine accessible aux personnes sourdes et mal voyantes.
              Le site devait permettre à l&apos;équipe d&apos;ajouter et
              modifier des articles facilement.
            </p>
            <p>
              Cette mission m&apos;a permis de mettre en pratique mes
              compétences en développement web tout en contribuant à une cause
              sociale importante, en créant une solution technologique
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-300 text-sm">
                  Création d&apos;un site web moderne et professionnel pour
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">
                  Système permettant à l&apos;équipe d&apos;ajouter et modifier
                  des articles
                </p>
              </div>
            </div>
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-300 text-sm">
                  Interface d&apos;administration simple et accessible pour
                  l&apos;équipe
                </p>
              </div>
              <div>
        ...
        <div className="bg-[#000814] border border-[#FFC300] rounded-lg p-8 mb-8">
          ...
          <div className="text-gray-300 space-y-4">
            <div>
              ...
              <p>
                Utilisation d&apos;une structure HTML sémantique avec des
                attributs ARIA appropriés pour assurer une navigation fluide
            ...
            <div>
              ...
              <p>
                Implémentation d&apos;une navigation complète au clavier avec
                des indicateurs de focus visibles et une logique de tabulation
                cohérente.
              </p>
            </div>
            <div>
              ...
              <p>
                Optimisation des contrastes de couleurs et de la typographie
                pour assurer une lisibilité maximale pour tous les utilisateurs.
              </p>
            </div>
            <div>
              <h3 className="text-white font-semibold mb-2">
              ...
              <p>
                Intégration de sous-titres, transcriptions et vidéos en Langue
                des Signes Française (LSF) pour rendre le contenu accessible aux
                personnes sourdes.
              </p>
            </div>
          </div>
        ...
        <div className="bg-[#000814] border border-[#FFC300] rounded-lg p-8 mb-8">
          ...
          <div className="text-gray-300 space-y-4">
            <div>
              ...
              <p>
                La conception d&apos;un site véritablement accessible pour les
                personnes sourdes et mal voyantes a nécessité une approche
                inclusive dès la conception.
              </p>
            </div>
            <div>
              <h3 className="text-white font-semibold mb-2">
              ...
              <p>
                La création d&apos;un CMS léger mais fonctionnel pour une équipe
                non-technique a demandé un équilibre entre simplicité et
                fonctionnalité.
              </p>
            </div>
            <div>
              ...
              <p>
                L&apos;optimisation des performances tout en maintenant un
                niveau élevé d&apos;accessibilité a été un défi technique
                majeur.
              </p>
            </div>
            <div>
              ...
              <p>
                L&apos;intégration de différents types de contenu (texte,
                vidéos, LSF) de manière cohérente et accessible a nécessité une
        ...
        <div className="bg-[#000814] border border-[#FFC300] rounded-lg p-8 mb-8">
          ...
          <div className="text-gray-300 space-y-4">
            <p>
              Cette mission freelance m&apos;a permis de contribuer à une cause
              sociale importante en créant une solution technologique
              véritablement inclusive pour une association dédiée aux personnes
              sourdes et mal voyantes.
            </p>
            <p>
              L&apos;approche d&apos;accessibilité universelle m&apos;a appris
              l&apos;importance de concevoir des solutions inclusives dès le
              départ, et non comme une fonctionnalité ajoutée après coup.
            </p>
            <p>
              La création d&apos;un CMS léger pour une équipe non-technique
              m&apos;a donné une vision claire de l&apos;importance de
              l&apos;expérience utilisateur dans les outils
              d&apos;administration, même pour des fonctionnalités simples.
            </p>
            <p>
              Cette expérience freelance a renforcé mes compétences en
              développement web et m&apos;a sensibilisé aux enjeux
              d&apos;accessibilité numérique, compétences précieuses pour ma
