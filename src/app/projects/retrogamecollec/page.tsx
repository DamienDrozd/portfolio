    ...
    <div className="min-h-screen bg-[#000814] text-white">
      ...
      <div className="pt-32 pb-16 max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h1 className="text-[#FFC300] text-5xl font-bold mb-4">RetroGameCollec</h1>
          <p className="text-white text-xl mb-2">Application pour collectionneurs de jeux vidéo rétro</p>
          ...
          <div className="flex justify-center space-x-4 mb-8">
            ...
            <span className="bg-[#FFC300] text-[#000814] px-4 py-2 rounded-lg font-semibold">MongoDB</span>
            <span className="bg-[#FFC300] text-[#000814] px-4 py-2 rounded-lg font-semibold">IGDB API</span>
        ...
        <div className="bg-[#000814] border border-[#FFC300] rounded-lg p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                <h3 className="text-white font-semibold mb-2">Gestion de collections</h3>
                <p className="text-gray-300 text-sm">
                  Organisation complète de sa ludothèque avec recherche et filtres avancés
                </p>
              </div>
              <div>
                <h3 className="text-white font-semibold mb-2">Découverte de titres</h3>
                <p className="text-gray-300 text-sm">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-white font-semibold mb-2">Partage communautaire</h3>
                <p className="text-gray-300 text-sm">
                  Partage public de collections et interaction entre collectionneurs
                </p>
              </div>
              <div>
                <h3 className="text-white font-semibold mb-2">Classification avancée</h3>
                <p className="text-gray-300 text-sm">
        ...
        <div className="bg-[#000814] border border-[#FFC300] rounded-lg p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              <h3 className="text-white font-semibold text-lg mb-3">Données & Intégrations</h3>
              <ul className="text-gray-300 space-y-2">
                <li>• MongoDB</li>
                <li>• IGDB API</li>
        ...
        <div className="bg-[#000814] border border-[#FFC300] rounded-lg p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-white font-semibold text-lg mb-3">Base de données</h3>
              <ul className="text-gray-300 space-y-2">
            ...
            <div>
              <h3 className="text-white font-semibold text-lg mb-3">Performance</h3>
              <ul className="text-gray-300 space-y-2">
        ...
        <div className="bg-[#000814] border border-[#FFC300] rounded-lg p-8">
          ...
          <div className="text-gray-300 space-y-4">
            ...
            <p>
              Ce projet démontre ma capacité à créer des solutions complètes et à gérer des projets 
              personnels de bout en bout, compétences précieuses pour ma carrière de développeur.
            </p>
          </div>
        </div>
      </div>
