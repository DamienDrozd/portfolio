  ...
  return (
    <div className="flex items-center justify-center mt-32 mb-24">
      <Image 
        ...
        alt="Damien Drozd - Développeur Web Freelance basé à Montpellier, spécialisé en React, Next.js et Python" 
        width={150} 
        height={150}
      ...
      <div className="ml-8">
        ...
        <h2 className="text-white text-2xl mb-2">Développeur Web Freelance</h2>
