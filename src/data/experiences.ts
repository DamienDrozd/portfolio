...
export const experiences: Experience[] = [
  {
    ...
    description:
      "Développement d'application mobile React Native, création d'APIs avec FastAPI et déploiement sur Azure.",
    technologies: ["React Native", "FastAPI", "Azure"],
    slug: "reconomia",
    type: "internship",
    companyUrl: "https://www.reconomia.com/",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Conception d'APIs REST et interfaces back-office. Projets data de bout en bout avec Django et Flask.",
    technologies: ["Django", "Flask", "Data Science"],
    slug: "lawebox",
    type: "fulltime",
    companyUrl: "https://www.lawebox.com/",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Site web vitrine accessible aux personnes sourdes et mal voyantes. CMS léger avec Firebase.",
    technologies: ["Next.js", "Firebase", "Accessibilité"],
    slug: "freelance",
    type: "freelance",
    projectUrl: "https://www.seniors-sourds-dependants.fr/",
    achievements: [
