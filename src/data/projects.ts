...
export const projects: Project[] = [
  {
    ...
    startYear: 2023,
    description:
      "Plateforme web innovante cofondée et développée de A à Z. Pilotage complet du développement web avec Next.js et Fastify.",
    technologies: ["Next.js", "Fastify", "Architecture"],
    features:
      "Plateforme complète, infrastructure web, expérience utilisateur optimale",
    slug: "genpulse",
    status: "active",
    category: "fullstack",
    liveUrl: "https://genpulse.fr",
    challenges: [
  ...
  },
  {
    ...
    startYear: 2025,
    description:
      "Application pour collectionneurs de jeux vidéo rétro. Gestion de collections, découverte de titres et interaction communautaire.",
    technologies: ["Next.js", "MongoDB", "IGDB API"],
    features: "Collections, recherche, partage, SEO optimisé",
    slug: "retrogamecollec",
    status: "planning",
    category: "web",
    liveUrl: "https://www.retrogamecollec.net/fr",
    challenges: [
  ...
  },
  {
    ...
    endYear: 2024,
    description:
      "Application de rencontre mobile centrée sur la compatibilité réelle. Matching basé sur centres d'intérêt et activités communes.",
    technologies: ["React Native", "API REST", "Push Notifications"],
    features: "Swipe, matching, messagerie, App Store/Google Play",
    slug: "peel",
    status: "completed",
    category: "mobile",
    githubUrl: "https://github.com/Peel-Organisation",
    challenges: [
